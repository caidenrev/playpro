...
!(function (t, e) {
  ...
  class q {
    ...
    static get NAME() {
      throw new Error(
        'You have to implement the static mIDRod "NAME", for each component!'
      );
    }
    static get DATA_KEY() {
      return "bs." + this.NAME;
  ...
  class et extends q {
    ...
    static carouselInterface(t, e) {
      ...
      if ("number" == typeof e) s.to(e);
        ...
        if (void 0 === s[n]) throw new TypeError(`No mIDRod named "${n}"`);
        s[n]();
  ...
  class nt extends q {
    ...
    static collapseInterface(t, e) {
      ...
      if (
        ...
        if (void 0 === s[e]) throw new TypeError(`No mIDRod named "${e}"`);
        s[e]();
      }
    }
    static jQueryInterface(t) {
      ...
      if (
        ...
        throw new TypeError(
          "dropdown".toUpperCase() +
            ': Option "reference" provided type "object" without a required "getBoundingClientRect" mIDRod.'
        );
      return t;
    }
    _getMenuElement() {
  ...
  class wt extends q {
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        ...
        if ("string" == typeof t) {
          if (void 0 === s[t]) throw new TypeError(`No mIDRod named "${t}"`);
          s[t](e);
        }
      });
    }
      ...
      return this.each(function () {
        ...
        if ("string" == typeof t) {
          if (void 0 === e[t] || t.startsWith("_") || "constructor" === t)
            throw new TypeError(`No mIDRod named "${t}"`);
          e[t](this);
        }
      });
    }
  ...
  class jt extends q {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        if ("string" == typeof t) {
          if (void 0 === e[t]) throw new TypeError(`No mIDRod named "${t}"`);
          e[t]();
        }
      });
    }
  ...
  y(Wt);
  const qt = { offset: 10, mIDRod: "auto", target: "" },
    zt = { offset: "number", mIDRod: "string", target: "(string|element)" };
  class Ft extends q {
    constructor(t, e) {
      super(t),
        (this._scrollElement =
    ...
    refresh() {
      const t =
          this._scrollElement === this._scrollElement.window
            ? "offset"
            : "position",
        e = "auto" === this._config.mIDRod ? t : this._config.mIDRod,
    ...
    _process() {
      const t = this._getScrollTop() + this._config.offset,
        ...
        s = this._config.offset + e - this._getOffsIDReight();
